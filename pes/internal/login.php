		...
		<div class="container text-center " style="margin-top:115px;width:530px;background-color:white;padding:30px;">
			<div>
				...
				<form method="post">
					...
					<br/>
					<br/>
					<label class="text-center"><a style="color:gray" href="../forgetpassward/int_forget_pass.php?int">Forget Password</a></label><br/>
...
<?php
	if(isset($_POST['login'])){
		$email = $_POST['email'];
		$pwd = $_POST['pwd'];
		$query=mysqli_query($con,"select * from int_reg where email ='$email' and password = '$pwd'");
		
		if(mysqli_num_rows($query)){
			$_SESSION['int_email']=$_POST['email'];
			$username=mysqli_fetch_row($query);
			$_SESSION['int_user']=$username[1];
