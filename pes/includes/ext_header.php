...
<div style="background-color:rgba(50,20,1,0.5);width:100%;height:100px;">
	...
	<div style="width:50%;float:right;margin-top:15px;color:black">
		...
		<?php if(isset($_SESSION['ext_user'])){ ?>
		<font style="font-size:20px;"><div style="float:right;margin-right:8px;"><?php echo 'Welcome : '.$_SESSION['ext_user']; ?>|<a href="../includes/changepass.php?ext">Change Password</a>|<a href="../includes/ext_logoff.php">Log Off</a></div></font>
		<?php } ?>
		</div>
		<div style="height:50%;width:100%;">
